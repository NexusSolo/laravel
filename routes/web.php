...
Route::group(['prefix' => 'settings', 'middleware' => 'auth'], function () {
  ...
  Route::get('team','SettingsController@team')->name('settings-team');
});

Route::group(['prefix' => 'invite'], function () {
  Route::get('accept/{token}','InviteController@invited')->name('invite-view');
  Route::post('accept','InviteController@accept')->name('invite-accept');
  Route::post('send','InviteController@send_invite')->name('invite-send');
});
